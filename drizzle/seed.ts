...
async function main() {
  ...
  const unitCostRows: (typeof configUnitCosts.$inferInsert)[] = [
    ...
    { grupo: "obras_civis_condominio", itemCodigo: "muro_condominio", itemDescricao: "Muro de fechamento (tijolo)", unidade: "m", valorUnitario: "626.10", regiao, dataBase: now, fonte: "Cotação — Residencial Mirante (PM): muro em bloco cerâmico rebocado e pintado" },
    { grupo: "obras_civis_condominio", itemCodigo: "muro_cerca_metalica", itemDescricao: "Muro de fechamento (cerca metálica)", unidade: "m", valorUnitario: "514.00", regiao, dataBase: now, fonte: "Cotação — Residencial Mirante (PM): muro em cerca metálica" },
